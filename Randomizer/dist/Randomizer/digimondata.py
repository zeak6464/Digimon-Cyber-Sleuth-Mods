...
def digimondata_func():
    ...
    suppot  = "./infolist/supportskills.csv"
    ...
    support = pandas.read_csv(suppot).sample(n=375,replace=True)
    ...
    df.insert(loc=1,column="memoryUse",value= 1)
    ...
    df.insert(loc=11,column="equipSlots",value= 3)
    df.insert(loc=12,column="supportSkill",value= support)
    
    df.insert(loc=13,column="sMove1",value= sMove1)
    df.insert(loc=14,column="sMove1Level",value= 1)
    df.insert(loc=15,column="sMove2",value= sMove2)
    df.insert(loc=16,column="sMove2Level",value= 1)
    df.insert(loc=17,column="move1",value= move1)
    df.insert(loc=18,column="move1Level",value= 2)
    df.insert(loc=19,column="move2",value= move2)
    df.insert(loc=20,column="move2Level",value= 3)
    df.insert(loc=21,column="move3",value= move3)
    df.insert(loc=22,column="move3Level",value= 4)
    df.insert(loc=23,column="move4",value= move4)
    df.insert(loc=24,column="move4Level",value= 5)
    df.insert(loc=25,column="move5",value= move5)
    df.insert(loc=26,column="move5Level",value= 6)
    df.insert(loc=27,column="move6",value= 0)
    df.insert(loc=28,column="move6Level",value= 0)
    
    df.insert(loc=29,column="expValue",value= (pandas.read_csv(file_name)["expValue"])*2)
