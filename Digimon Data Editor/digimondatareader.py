...
filepath = "./digimondata/modfiles/data/digimon_farm_para.mbe/digimon.csv"
...
def update():
    ...
    try:
        img2=PhotoImage(file='images/'+Data[index][0]+'.png')
    except:
        img2=PhotoImage(file='images/0.png')
        pass
